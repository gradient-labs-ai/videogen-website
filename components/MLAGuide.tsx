    ...
    <div className="relative overflow-hidden bg-gray-50 py-16">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="prose prose-lg prose-indigo mx-auto mt-6 text-gray-500">
          <h1>MLA (Modern Language Association) citation format</h1>
          <p>
            MLA citation format is a commonly used citation style in the
            humanities and liberal arts. It is important to properly cite
          ...
          <Callout
            text="Free MLA Citation Generator."
            cta="Try Now"
          ...
          <p>
            At the end of your paper, you should include a Works Cited page that
            provides full details about all the sources you have cited in your
            paper. The Works Cited page should be alphabetized by the first word
            of each entry. The formatting of the entries will depend on the type
            of source being cited.
          </p>
          <h2>Formatting</h2>
          <p>
            The Works Cited entries should be formatted according to the
          ...
          <ul>
            <li>
              ...
              the book, publisher, year of publication, and the medium of
              publication. For example:{" "}
              <em>
                Smith, John. The History of Time. Random House, 2020. Print.
              </em>
            </li>
            <li>
          ...
          <ul>
            <li>
              <em>Smith, John. The History of Time. Random House, Print.</em>
            </li>
            <li>
              <em>
                Smith, John. &ldquo;The Benefits of Meditation.&ldquo;
          ...
          <p>
            ...
            using MLA citation format. It is important to be consistent and
