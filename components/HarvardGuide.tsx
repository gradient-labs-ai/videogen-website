    ...
    <div className="relative overflow-hidden bg-gray-50 py-16">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="prose prose-lg prose-indigo mx-auto mt-6 text-gray-500">
          <h1>Harvard citation format</h1>
          <p>
            Harvard citation format is a commonly used citation style in the
            humanities and social sciences. It is important to properly cite
          ...
          <Callout
            text="Free Harvard Citation Generator."
            cta="Try Now"
          ...
          <p>
            ...
            using Harvard citation format. It is important to be consistent and
